  ...
  return (
    <form id="profile-form" onSubmit={handleSubmit}>
      <div className="grid gap-3 lg:gap-6 lg:grid-cols-2">
        {/* 기본 정보 */}
        <Card className="lg:col-span-2 lg:p-2">
        <CardHeader className="px-4 lg:px-6 pt-4 lg:pt-6">
          <CardTitle className="text-base lg:text-2xl">기본 정보</CardTitle>
          ...
          {isEditing ? (
            <div className="grid gap-3 lg:gap-4 lg:grid-cols-2">
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="full_name" className="text-sm lg:text-base">이름 *</Label>
                <Input
                  id="full_name"
                  value={fullName}
              ...
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="phone" className="text-sm lg:text-base">전화번호 *</Label>
                <Input
                  id="phone"
                  type="tel"
                  value={phone}
              ...
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="birth_date" className="text-sm lg:text-base">생년월일</Label>
                <Input
                  id="birth_date"
                  type="date"
                  value={birthDate}
              ...
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="gender" className="text-sm lg:text-base">성별</Label>
                <Select value={gender} onValueChange={setGender}>
                  <SelectTrigger className="h-9 lg:h-12">
            ...
            <div className="grid gap-3 lg:gap-4 lg:grid-cols-2">
              <div className="space-y-1 lg:space-y-1.5">
                <p className="text-xs lg:text-sm text-muted-foreground">이름</p>
                <p className="font-medium text-sm lg:text-base">{fullName || '이름 없음'}</p>
              </div>

              <div className="space-y-1 lg:space-y-1.5">
                <p className="text-xs lg:text-sm text-muted-foreground">전화번호</p>
                <p className="font-medium text-sm lg:text-base">{phone || '전화번호 없음'}</p>
              </div>

              <div className="space-y-1 lg:space-y-1.5">
                <p className="text-xs lg:text-sm text-muted-foreground">나이</p>
              ...
              <div className="space-y-1 lg:space-y-1.5">
                <p className="text-xs lg:text-sm text-muted-foreground">성별</p>
                <p className="font-medium text-sm lg:text-base">
      ...
      <Card className="lg:p-2">
        <CardHeader className="px-4 lg:px-6 pt-4 lg:pt-6">
          <CardTitle className="text-base lg:text-2xl">주소 정보</CardTitle>
        </CardHeader>
        <CardContent className="px-4 lg:px-6 pb-4 lg:pb-6">
          {isEditing ? (
            <div className="space-y-3 lg:space-y-4">
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="address" className="text-sm lg:text-base">주소</Label>
                <Input
                  id="address"
                  value={address}
              ...
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="address_detail" className="text-sm lg:text-base">상세 주소</Label>
                <Input
                  id="address_detail"
                  value={addressDetail}
            ...
            <div className="space-y-2 lg:space-y-3">
              {address || addressDetail ? (
                <div className="space-y-1 lg:space-y-1.5">
                  <p className="text-xs lg:text-sm text-muted-foreground">주소</p>
                  <p className="font-medium text-sm lg:text-base">
                    {address && addressDetail ? `${address}, ${addressDetail}` : address || addressDetail}
                  </p>
                </div>
              ) : (
                <p className="text-sm lg:text-base text-muted-foreground">주소 정보가 없습니다</p>
              )}
            </div>
          )}
        </CardContent>
      ...
      {/* 건강 정보 */}
      <Card className="lg:col-span-1 lg:p-2">
        <CardHeader className="px-4 lg:px-6 pt-4 lg:pt-6">
          <CardTitle className="text-base lg:text-2xl">건강 정보</CardTitle>
        </CardHeader>
        <CardContent className="px-4 lg:px-6 pb-4 lg:pb-6">
          {isEditing ? (
            <div className="space-y-3 lg:space-y-4">
              <div className="space-y-1.5 lg:space-y-2">
                <Label htmlFor="mobility_level" className="text-sm lg:text-base">거동 수준</Label>
            ...
            <div className="space-y-2 lg:space-y-3">
              {mobilityLevel ? (
                <div className="space-y-1 lg:space-y-1.5">
                  <p className="text-xs lg:text-sm text-muted-foreground">거동 수준</p>
                  <p className="font-medium text-sm lg:text-base">
                ...
                <p className="text-sm lg:text-base text-muted-foreground">건강 정보가 없습니다</p>
              )}
            </div>
          )}
        </CardContent>
        ...
        <CardHeader className="px-4 lg:px-6 pt-4 lg:pt-6">
          <Collapsible open={isGuardianOpen} onOpenChange={setIsGuardianOpen}>
            <CollapsibleTrigger className="flex items-center justify-between w-full">
              <CardTitle className="text-base lg:text-2xl">보호자 정보 (선택)</CardTitle>
              {isGuardianOpen ? (
                <ChevronUp className="h-4 w-4 lg:h-5 lg:w-5 shrink-0" />
              ) : (
                <ChevronDown className="h-4 w-4 lg:h-5 lg:w-5 shrink-0" />
              )}
            </CollapsibleTrigger>
            <CollapsibleContent>
              <CardContent className="px-4 lg:px-6 pb-4 lg:pb-6 pt-3 lg:pt-4">
                {isEditing ? (
                  <div className="grid gap-3 lg:gap-4 lg:grid-cols-2">
                    <div className="space-y-1.5 lg:space-y-2">
                      <Label htmlFor="guardian_name" className="text-sm lg:text-base">보호자 이름</Label>
                      <Input
                        id="guardian_name"
                        value={guardianName}
                    ...
                    <div className="space-y-1.5 lg:space-y-2">
                      <Label htmlFor="guardian_relationship" className="text-sm lg:text-base">관계</Label>
                    ...
                    <div className="space-y-1.5 lg:space-y-2 lg:col-span-2">
                      <Label htmlFor="guardian_phone" className="text-sm lg:text-base">보호자 연락처</Label>
                      <Input
                        id="guardian_phone"
                        type="tel"
                        value={guardianPhone}
                    ...
                    {guardianName || guardianRelationship || guardianPhone ? (
                      <>
                        {guardianName && (
                          <div className="space-y-1 lg:space-y-1.5">
                            <p className="text-xs lg:text-sm text-muted-foreground">이름</p>
                            <p className="font-medium text-sm lg:text-base">{guardianName}</p>
                          </div>
                        )}
                        {guardianRelationship && (
                          <div className="space-y-1 lg:space-y-1.5">
                            <p className="text-xs lg:text-sm text-muted-foreground">관계</p>
                            <p className="font-medium text-sm lg:text-base">
                        ...
                        {guardianPhone && (
                          <div className="space-y-1 lg:space-y-1.5 lg:col-span-2">
                            <p className="text-xs lg:text-sm text-muted-foreground">연락처</p>
                            <p className="font-medium text-sm lg:text-base">{guardianPhone}</p>
                          </div>
                        )}
                      </>
                    ) : (
                      <p className="text-sm lg:text-base text-muted-foreground lg:col-span-2">
                        보호자 정보가 없습니다
                      </p>
                    )}
                  </div>
      ...
      <Card className="lg:col-span-2 lg:p-2">
        <CardHeader className="px-4 lg:px-6 pt-4 lg:pt-6">
          <CardTitle className="text-base lg:text-2xl">기타 메모</CardTitle>
        </CardHeader>
        <CardContent className="px-4 lg:px-6 pb-4 lg:pb-6">
          {isEditing ? (
            <Textarea
            ...
            <div>
              {notes ? (
                <p className="text-sm lg:text-base break-words whitespace-pre-wrap">{notes}</p>
              ) : (
                <p className="text-sm lg:text-base text-muted-foreground">기타 메모가 없습니다</p>
              )}
            </div>
          )}
        </CardContent>
