  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 md:gap-6 md:p-6">
        {/* Page Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight">트레이너 대시보드</h1>
        ...
        {!trainer?.is_verified && (
          <Alert className="border-yellow-200 bg-yellow-50 dark:border-yellow-900 dark:bg-yellow-950">
            ...
            <AlertTitle className="text-yellow-900 dark:text-yellow-100">승인 대기 중</AlertTitle>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-xs">예약 현황</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Button asChild variant="outline" size="sm" className="w-full" disabled={!trainer?.is_verified}>
          ...
          <Card className="hover:bg-muted/50 transition-colors">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <CardTitle className="text-sm">프로그램 관리</CardTitle>
                  <CardDescription className="text-xs">프로그램 등록</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Button variant="outline" size="sm" className="w-full" disabled={!trainer?.is_verified}>
                관리하기
                <ArrowUpRight className="ml-2 h-3 w-3" />
              </Button>
            </CardContent>
          ...
          <Card className="hover:bg-muted/50 transition-colors">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <CardTitle className="text-sm">리뷰 관리</CardTitle>
                  <CardDescription className="text-xs">고객 리뷰</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          ...
          <CardContent className="grid gap-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className={`font-medium ${trainer?.is_verified ? 'text-green-600' : 'text-yellow-600'}`}>
