      ...
      <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
        ...
        {!trainer?.is_verified && (
          <Alert className="border-yellow-200 bg-yellow-50">
            ...
            <AlertTitle className="text-yellow-900">승인 대기 중</AlertTitle>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card className="hover:shadow-md transition-all hover:border-primary">
            ...
            <CardContent>
              <Button asChild variant="outline" className="w-full" disabled={!trainer?.is_verified}>
          ...
          <Card className="hover:shadow-md transition-all hover:border-primary">
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <CardTitle className="text-base">프로그램 관리</CardTitle>
                  <CardDescription className="text-xs">재활 프로그램 등록</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full" disabled={!trainer?.is_verified}>
                관리하기
                <ArrowUpRight className="ml-2 h-4 w-4" />
              </Button>
            </CardContent>
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-xs">고객 리뷰 확인</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          ...
          <CardContent className="grid gap-2">
            ...
            <div className="flex justify-between">
              ...
              <span className={trainer?.is_verified ? 'text-green-600 font-medium' : 'text-yellow-600 font-medium'}>
