...
export async function updateNotificationSettings(formData: FormData) {
  ...
  const emailPayment = formData.get('email_payment') === 'true'
  ...
  const pushPayment = formData.get('push_payment') === 'true'
  ...
  revalidatePath('/trainer/settings/notifications')
  return { success: true }
}
