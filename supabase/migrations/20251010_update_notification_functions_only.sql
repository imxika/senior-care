-- Update notification functions to use 'link' parameter (not related_id)
-- Table already has 'link' column, just need to update functions

-- Step 1: Update create_notification function
...
-- Step 2: Update review notification trigger functions
